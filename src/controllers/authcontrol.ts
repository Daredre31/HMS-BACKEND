...
studentLogin = async (req:Request , res:Response) => {
    ...
    try {
        ...
        const accesstoken = Jwt.sign({id:loginStudent._id , tokenId:loginStudent.tokenId , role:loginStudent.role} , secret , {expiresIn:"1d"})
...
// CREATION OF ADMIN/ ADMIN SIGNUP
  ...
  adminLogin = async(req:Request , res:Response)=> {
    ...
    try {
        ...
        const Accesstoken = Jwt.sign({id:checkEmail._id , role:checkEmail.role } , secret , {expiresIn:"1d"})
        const refreshToken = Jwt.sign({sessionId} , refresh , {expiresIn:'7d'})
  ...
  refreshAcessToken = async(req:Request , res:Response) => {
   ...
   try {
    ...
    const accessToken = Jwt.sign({id:sessionData.userId , role:sessionData.role} , process.env.JWT_SECRET as string , {expiresIn:'1d'})
